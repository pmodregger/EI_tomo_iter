...
iter_dict['factr'] = 1e4*1 # 1e9 works fine and fast
...
iter_dict['lambdamn'] = 0 # lambda for mean of mr



#%% do the iteration
rec_dict, funcs = iterlib.iter_single_shot(mflat,ICflat,m,ICsamp,iter_dict)
rec_abs0 = rec_dict['rec_slice_abs']
print('NMSE - no mean: ',pm.nmse(orga, rec_abs0))

#%%
rec_dict, funcs = iterlib.iter_single_shot(mflat,ICflat,m,ICsamp,iter_dict)
rec_abs1 = rec_dict['rec_slice_abs']
print('NMSE - yes mean: ',pm.nmse(orga, rec_abs1))
