...
take about 15 seconds to show the results. Script has to be run in the
...
Ndet = 720 # number of detector pixels
...
flatfactor = 20 # represents how often the flat IC is acquired in a scan
...
#%% using the forward model to generate the sinogram
...
if flatnoiseon: # add photon shot noise if turned on
    ICflat, dummy = countstat(ICflat*flatfactor)
    ICflat = ICflat/flatfactor
...
iter_dict['do_rec_mr'] = 0 # ring artefact removal
